...
\begin{figure}[!htbp]
 ...
 \label{Tri_1}
 \end{figure}\\ 
With known positions of the center of the circles d, i and j can be computed in the following way: \footnote{Indoor Robot Positioning using an Enhanced Trilateration Algorithm}
\begin{align}
d = |P_2 - P_1| \\
