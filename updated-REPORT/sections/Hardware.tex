\section[Hardware]{Hardware\footnote{Stephan}}\label{Sec_Har}
...
\footnotetext{Source of figure \ref{tag} (Paper Tag): www.kurzweilai.net/scientists-print-cheap-rfid-tags-on-paper}
\footnotetext{Source of figure \ref{wemos} (WeMos D1 Mini WiFi Module): www.github.com/mcauser/Fritzing-Part-WeMos-D1-Mini}
\begin{figure}[!htbp]
	\centering
