...
\begin{figure}[!htbp]
	...
	\label{amcl}
\end{figure}\\
\footnotetext{Source of figure \ref{amcl} (Adaptive Monte Carlo localization): www.moodle.tu-dortmund.de/mobile-robots}
...
\footnotetext{Source of figures \ref{local_map}, \ref{global_map}, \ref{robot_orientation} and \ref{correction_with_globalmap}: www.moodle.tu-dortmund.de/mobile-robots}
\end{itemize}
\begin{itemize}
