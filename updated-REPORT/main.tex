...
Abdulrahman Abouelkhair(198803)\\	                                         % Author info
...
\setcounter{enumi}{0} \include{sections/abstract}
...
\pagestyle{fancy} 
\lhead{Final report, Local positioning system pipeless plant, \today}
\chead{}
\rhead{Page \thepage}
\lfoot{}
\cfoot{}
...
\clearpage
\titleformat{\section}{\Large\bf}{\thesection}{20pt}{}
\include{sections/Pipelessplant}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\titleformat{\section}{\Large\bf}{\thesection}{20pt}{}
\include{sections/selection_process}
