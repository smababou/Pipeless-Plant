...
/* Version no. 1
 *  Program to read txt file from type "Degree ID RSSI Degree ID RSSI ..."
...
namespace ConsoleApp3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string Dateiinhalt = System.IO.File.ReadAllText(@"C:\Users\Stephan\Dropbox\Project_PP\C#_Files\Initialisierung_STtefan\Meas_StartingProc1.txt");
            ...
            for (int i = 0; i < 37; i++)
            {
                ...
                while (go_on == true)
                {
                    ...
                    init_array[x, j] = Int32.Parse(Worte[wordcount + 1]);
                    jj = j + 4;
                    init_array[x, jj] = Int32.Parse(Worte[wordcount + 2]);
                    wordcount_temp = wordcount + 3;
